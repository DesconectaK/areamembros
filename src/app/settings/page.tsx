...
const WhatsAppIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-primary-foreground" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="container mx-auto p-4 flex flex-col items-center min-h-full pt-8">
      ...
      >
        <Button
          variant="default"
          className="rounded-full h-16 w-16 p-0 flex items-center justify-center shadow-lg hover:bg-primary/90"
        >
          <WhatsAppIcon />
        </Button>
      </Link>
